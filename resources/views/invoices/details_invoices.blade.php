...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Bills</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/Invoice Details</span>
            </div>
        </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab6">
                                            ...
                                            <div class="card card-statistics">
                                                @can('Add Attachment')
                                                    <div class="card-body">
                                                        <p class="text-danger">* Attachments  pdf, jpeg ,.jpg , png </p>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('delete_file') }}" method="post">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                        <h6 style="color:#ee335e;">? Are You Sure You Want To Delete This File </h6>
                        </p>
