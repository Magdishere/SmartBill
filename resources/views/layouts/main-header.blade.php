                    ...
                    <div class="dropdown nav-item main-header-notification">
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-secondary text-right">
                                <div class="d-flex">
                                    <h6 class="dropdown-title mb-1 tx-15 text-warning font-weight-semibold">Notifications</h6>
                                    <span class="badge badge-pill badge-warning text-white mr-auto my-auto float-left"><a
                                            href="\MarkAsRead_all">Mark All As Read</a></span>
                                </div>
                                ...
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            ...
                                            <div class="notifyimg bg-white">
                                                <i class="fa fa-bell" style="color: #0f0f0f;"></i>
                                            </div>
                                            <div class="mr-3">
